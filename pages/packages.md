...
|---|---|---|---|---|
| **`naf/framework`**<br><span style="font-weight:400">NAF - the ultra-light, functional PHP framework for fast microservices and APIs.</span> | `v0.2.6` | — | — | `>=8.3` |
...
| **`naf/rbac`**<br><span style="font-weight:400">Roles, permissions and the rules for handing them out, for NAF hosts.</span> | `v0.1.1` | `naf/auth`, `naf/database`, `naf/framework` | — | `>=8.3` |
...
| **`naf/websocket`**<br><span style="font-weight:400">A WebSocket server for NAF hosts, in plain PHP: it carries that something changed, never what.</span> | `v0.1.0` | `naf/framework` | — | `>=8.3` |
