...
|---|---|---|---|---|
| **`naf/framework`**<br><span style="font-weight:400">NAF - the ultra-light, functional PHP framework for fast microservices and APIs.</span> | `v0.2.3` | — | — | `>=8.3` |
| **`naf/auth`**<br><span style="font-weight:400">Authentication and permission checks for NAF, with your own user model.</span> | `v0.2.1` | `naf/framework` | `naf/orm`, `naf/session` | `>=8.3` |
| **`naf/cli`**<br><span style="font-weight:400">NAF CLI Plugin for console applications.</span> | `v0.2.1` | `naf/framework` | — | `>=8.3` |
| **`naf/client`**<br><span style="font-weight:400">NAF Client Plugin to make simple http requests.</span> | `v0.2.1` | `naf/framework` | — | `>=8.3` |
...
| **`naf/orm`**<br><span style="font-weight:400">NAF ORM Plugin.</span> | `v0.2.1` | `naf/database`, `naf/framework` | — | `>=8.3` |
| **`naf/queue`**<br><span style="font-weight:400">NAF Queue Plugin for asynchronous jobs.</span> | `v0.2.2` | `naf/cli`, `naf/framework` | — | `>=8.3` |
| **`naf/schedule`**<br><span style="font-weight:400">NAF Schedule Plugin for recurring Tasks.</span> | `v0.2.2` | `naf/framework`, `naf/queue` | — | `>=8.3` |
| **`naf/session`**<br><span style="font-weight:400">NAF Session Plugin for storing data across requests.</span> | `v0.2.1` | `naf/framework` | `naf/database` | `>=8.3` |
| **`naf/view`**<br><span style="font-weight:400">NAF View Plugin with simple templating.</span> | `v0.2.1` | `naf/framework` | — | `>=8.3` |
